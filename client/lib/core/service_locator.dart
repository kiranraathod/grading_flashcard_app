...
Future<void> _registerBlocs() async {
  ...
  if (!sl.isRegistered<FlashcardBloc>()) {
    sl.registerFactory<FlashcardBloc>(
      () => FlashcardBloc(
        repository: sl<FlashcardRepository>(),
      ),
    );
  }
...
void logRegistrations() {
  ...
  debugPrint('  Services: ${sl.isRegistered<StorageService>() ? '✅' : '❌'} StorageService');
  debugPrint('  Services: ${sl.isRegistered<SupabaseService>() ? '✅' : '❌'} SupabaseService');
  debugPrint('  Services: ${sl.isRegistered<ConnectivityService>() ? '✅' : '❌'} ConnectivityService');
  debugPrint('  Services: ${sl.isRegistered<ApiService>() ? '✅' : '❌'} ApiService');
  debugPrint('  Repositories: ${sl.isRegistered<FlashcardRepository>() ? '✅' : '❌'} FlashcardRepository');
  debugPrint('  BLoCs: ${sl.isRegistered<FlashcardBloc>() ? '✅' : '❌'} FlashcardBloc');
}