...
class FlashcardProgressUpdated extends FlashcardEvent {
  ...
  @override
  String toString() => 'FlashcardProgressUpdated(setId: $setId, cardId: $cardId, isCompleted: $isCompleted)';
}
...
class FlashcardMarkedForReview extends FlashcardEvent {
  ...
  @override
  String toString() => 'FlashcardMarkedForReview(setId: $setId, cardId: $cardId, isMarked: $isMarkedForReview)';
}
...
class FlashcardSyncStatusUpdated extends FlashcardEvent {
  ...
  @override
  String toString() => 'FlashcardSyncStatusUpdated(status: $syncStatus, isSyncing: $isSyncing)';
}
